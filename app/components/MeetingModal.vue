                    ...
                    <section style="margin-bottom: 1.5rem">
                        ...
                        >
                            <table role="grid">
                                ...
                                <tbody>
                                    <tr
                                        v-for="rep in meeting.assignedReps"
                                        :key="rep.id"
                                    >
                                        <td>{{ rep.name }}</td>
                                        <td>{{ rep.title || "-" }}</td>
